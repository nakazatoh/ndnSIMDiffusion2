...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  inline void
  SetBPitsize(double pitsize);

  inline double
  GetBPitsize() const;

  inline void
  SetPitsize(double pitsize);
...
private:
  ...
  double m_pitsizedif;
  double m_f_pitsize {0.0};
  double m_pitsize;
  double m_b_pitsize {0.0};
...
inline void
Face::SetBPitsize(double pitsize)
{
  m_b_pitsize = pitsize;
}

inline double
Face::GetBPitsize() const
{
  return m_b_pitsize;
}

inline void
Face::SetFPitsize(double pitsize)
{
  m_f_pitsize = pitsize;
}

inline double
Face::GetFPitsize() const
{
  return m_f_pitsize;
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
