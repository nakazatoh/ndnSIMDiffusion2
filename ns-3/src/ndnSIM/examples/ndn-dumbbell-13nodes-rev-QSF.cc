...
NS_LOG_COMPONENT_DEFINE("ndn-dumbbell-13nodes-rev-QSF");
...
main (int argc, char *argv[])
{
  ...
  consumerHelper.SetAttribute ("Frequency", StringValue ("60")); // 200 interests a second
  ...
  consumerHelper.SetAttribute ("Frequency", StringValue ("30")); // 50 interests a second
  ...
  std::string drop_trace("drop-trace-dumbbell-13nodes-rev-QSF.txt");
  std::string rate_trace("rate-trace-dumbbell-13nodes-rev-QSF.txt");
  std::string aggregate_trace("aggregate-trace-dumbbell-13nodes-rev-QSF.txt");
  std::string app_delay_trace("app-delays-trace-dumbbell-13nodes-rev-QSF.txt");
