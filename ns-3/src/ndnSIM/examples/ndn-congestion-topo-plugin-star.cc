...
main (int argc, char *argv[])
{
  ...
  //ndnHelper.EnableLimits(true, Seconds(0.2),0,1250); //default?
...
//  Simulator::Schedule (Seconds (0), PeriodicStatsPrinter, Names::Find<Node>("Dst2"), Seconds (0.01));
  ...
  Simulator::Stop (Seconds (0.3));//lee: origin is 15

  L2RateTracer::InstallAll ("drop-trace-star-change_160.txt", Seconds (0.1));
  ndn::L3RateTracer::InstallAll("rate-trace-congestion-star-dfcc-change_160.txt",Seconds (0.1));
  ndn::L3AggregateTracer::InstallAll("aggregate-trace-congestion-star-dfcc-change_160.txt",Seconds (0.1));
