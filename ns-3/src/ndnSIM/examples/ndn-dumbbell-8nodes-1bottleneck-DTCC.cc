...
NS_LOG_COMPONENT_DEFINE("ndn-dumbbell-8nodes-1bottleneck-DTCC");
...
main (int argc, char *argv[])
{
  ...
  std::string drop_trace("drop-trace-dumbbell-8nodes-1bn-DTCC.txt");
  std::string rate_trace("rate-trace-dumbbell-8nodes-1bn-DTCC.txt");
  std::string aggregate_trace("aggregate-trace-dumbbell-8nodes-1bn-DTCC.txt");
  std::string app_delay_trace("app-delays-trace-dumbbell-8nodes-1bn-DTCC.txt");
