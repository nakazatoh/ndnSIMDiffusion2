...
main (int argc, char *argv[])
{
  ...
  topologyReader.SetFileName ("src/ndnSIM/examples/topologies/topo-dumbbell-12nodes.txt");  //read topology
  topologyReader.Read ();
  ...
  std::string drop_trace("drop-trace-dumbbell-12nodes-DTCC.txt");
  std::string rate_trace("rate-trace-dumbbell-12nodes-DTCC.txt");
  std::string aggregate_trace("aggregate-trace-dumbbell-12nodes-DTCC.txt");
  std::string app_delay_trace("app-delays-trace-dumbbell-12nodes-DTCC.txt");
