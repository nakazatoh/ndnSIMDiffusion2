...
main (int argc, char *argv[])
{
  ...
  std::string drop_trace("drop-trace-dumbbell-12nodes-2.txt");
  std::string rate_trace("rate-trace-dumbbell-12nodes-2.txt");
  std::string aggregate_trace("aggregate-trace-dumbbell-12nodes-2.txt");
  std::string app_delay_trace("app-delays-trace-dumbbell-12nodes-2.txt");
