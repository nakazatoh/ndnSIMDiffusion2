...
NS_LOG_COMPONENT_DEFINE("ndn-qsf-QSF");
...
//  consumerHelper.SetAttribute ("Window", StringValue("5"));
  ...
  std::string drop_trace("drop-trace-qsf-QSF.txt");
  std::string rate_trace("rate-trace-qsf-QSF.txt");
  std::string aggregate_trace("aggregate-trace-qsf-QSF.txt");
  std::string app_delay_trace("app-delays-trace-qsf-QSF.txt");
