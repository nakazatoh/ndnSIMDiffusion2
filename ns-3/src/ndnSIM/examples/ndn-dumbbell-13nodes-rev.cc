...
NS_LOG_COMPONENT_DEFINE("ndn-dumbbell-13nodes-rev");
...
main (int argc, char *argv[])
{
  ...
  std::string drop_trace("drop-trace-dumbbell-13nodes-rev.txt");
  std::string rate_trace("rate-trace-dumbbell-13nodes-rev.txt");
  std::string aggregate_trace("aggregate-trace-dumbbell-13nodes-rev.txt");
  std::string app_delay_trace("app-delays-trace-dumbbell-13nodes-rev.txt");
