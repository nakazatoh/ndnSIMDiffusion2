...
main (int argc, char *argv[])
{
  ...
  std::string drop_trace("drop-trace-2cross-10nodes-QSF.txt");
  std::string rate_trace("rate-trace-2cross-10nodes-QSF.txt");
  std::string aggregate_trace("aggregate-trace-2cross-10nodes-QSF.txt");
  std::string app_delay_trace("app-delays-trace-2cross-10nodes-QSF.txt");
