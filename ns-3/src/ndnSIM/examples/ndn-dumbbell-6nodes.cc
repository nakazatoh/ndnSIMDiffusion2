...
main (int argc, char *argv[])
{
  ...
  std::string drop_trace("drop-trace-dumbbell-6nodes.txt");
  std::string rate_trace("rate-trace-dumbbell-6nodes.txt");
  std::string aggregate_trace("aggregate-trace-dumbbell-6nodes.txt");
  std::string app_delay_trace("app-delays-trace-dumbbell-6nodes.txt");
