 ...
 *
 *     ./waf --run=ndn-3to3-dumbbell-QSF
 */


NS_LOG_COMPONENT_DEFINE("ndn-3to3-dumbbell-QSF");
...
main (int argc, char *argv[])
{
  ...
  ndnHelper.SetForwardingStrategy ("ns3::ndn::fw::BestRoute::PerOutFaceLimits::PerFibLimits","Limit","ns3::ndn::Limits::Rate","SelectSatPI", "2","InterestBuffering","true");
  ...
  consumerHelper.SetAttribute ("Frequency", StringValue ("550")); // 550 interests a second
  ...
  std::string drop_trace("drop-trace-3to3-dumbbell-QSF.txt");
  std::string rate_trace("rate-trace-3to3-dumbbell-QSF.txt");
  std::string aggregate_trace("aggregate-trace-3to3-dumbbell-QSF.txt");
  std::string app_delay_trace("app-delays-trace-3to3-dumbbell-QSF.txt");
